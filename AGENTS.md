...
This project is indexed by GitNexus as **mbv** (2636 symbols, 11585 relationships, 233 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
