...
This project is indexed by GitNexus as **mbv** (2975 symbols, 13037 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
