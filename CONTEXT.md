...
Power View is a formal view setting, not a transient keyboard toggle. The `v` key is reserved for the audio visualizer toggle; Power View belongs in the F2 settings surface.
