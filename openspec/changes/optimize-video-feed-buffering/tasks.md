...
- [ ] 1.1 Change the mpv playback initialization retained/back demuxer limit from 10MiB to 100MiB while preserving the 50MiB forward limit.
- [ ] 1.2 Confirm the initialization change applies consistently to playback runs containing Emby items, feed entries, or both, without changing source URL construction.

## 2. Verify playback behavior

- [ ] 2.1 Run `cargo check -p mbv-core`.
