...
- Hero-on-left media surfaces SHALL place a one-column `WideMediaList` in the right rail.
- Normal/non-wide selected-row replacement SHALL compose `InlineMediaBrowser`.
