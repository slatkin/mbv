...
- [ ] 1.1 `docs/architecture/interactive-surface-ledger.md`: confirm every row's
...
- [ ] 1.2 ADR 0022: bring its description of state ownership in line with the
      ...
      enforce.
- [ ] 1.3 `openspec/specs/interactive-component-framework/spec.md`: merge the
...
- [ ] 1.4 Record #607's acceptance criterion as met, citing
...
- [ ] 2.1 Archive the completed changes in the chain
      ...
      changes.
- [ ] 2.2 Report anything that could not be made true by editing documents
