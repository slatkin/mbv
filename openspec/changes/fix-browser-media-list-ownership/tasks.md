...
- [ ] 1.1 Add or update focused component/media-list tests proving stable-target ordinary refresh, local clamp, explicit re-anchor, bidirectional `ViewportAnchor` handoff (Wide↔Narrow preserving target plus offset), and retained-geometry hits including blank/header no-op; verify the targeted tests pass.
