...
- [x] 5.4 Manually verify against the pre-change build (git stash or commit `2dce938c^`) for Home, Music, TV, Feeds, Books, Podcast: pills full-width, hero two rows down, drag gap below the band, home-video count gone, Inline Search bar full-width.
