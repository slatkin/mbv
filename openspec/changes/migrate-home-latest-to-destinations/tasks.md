...
- [ ] 5.6 Remove Music Latest: Music is NOT a Latest-eligible destination (user decision 2026-09-23; invalidates accepted row 2.4). Remove Music's Latest selector arm and flat-Latest path, restore Music's pre-2.4 selector/list behaviour, update Music tests, and narrow `destination-latest-modes` eligibility to exclude Music (`cargo nextest run -p mbv`).
