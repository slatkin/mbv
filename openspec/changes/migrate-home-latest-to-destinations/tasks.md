...
- [ ] 5.5 Present Home as Continue: the tab SHALL be labelled `Continue` and the now-empty Selector row/pill bar SHALL be removed; update the Home render characterization and mouse-hover tests; verify (`cargo nextest run -p mbv`). Re-run the 5.1 gate suite after 5.4 and 5.5.
