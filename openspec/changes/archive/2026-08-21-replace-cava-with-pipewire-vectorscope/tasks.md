...
- [x] 6.2 Verify same-host Local daemon playback works without daemon/protocol changes, while remote, attached-session, and audio-pipe playback do not start local capture.
