...
- [x] 4.4 Defer responsive active-control ownership, Browser/Home identity and grid work, TV/Feeds/Audiobookshelf migration, universal ratchets, documentation sweep, and multi-select to follow-on changes under issue #681; sync and archive only after implementation, acceptance, and final OpenSpec validation.
