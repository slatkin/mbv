...
- Keep shared-data TCP confined to loopback/private-network endpoints: plaintext LAN transport is allowed, while TLS remains available as an optional defense in depth; WAN endpoints are rejected.
