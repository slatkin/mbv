...
- [x] 1.2 Replace Cava-specific core types with source-of-truth stereo sample, bounded overwrite-buffer, startup, and failure types.
...
- [x] 2.2 Copy complete sample pairs into the bounded buffer without blocking the capture callback.
...
- [x] 4.3 Target a 16 ms active-visualizer cadence and snapshot the newest sample window immediately before each draw rather than replaying visual frames.
