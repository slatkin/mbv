...
- [ ] 1.3 Reconcile non-grouped Music views against issue #681 before the Grouped Music follow-on is approved; record an explicit included or out-of-scope decision with source evidence in this umbrella and verify no screen is silently classified as complete.
