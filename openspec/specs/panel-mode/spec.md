...
- **WHEN** the application starts, or the terminal narrows below 80 columns, with no mini-view state yet
...
- **THEN** the layout switches to showing only the other panel (library-only ↔ queue-only), full width
