...
## Purpose
Defines the authority boundary for interactive components: they own local interaction state and emit typed messages for work that crosses into shell-owned authority.
