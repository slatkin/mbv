...
/// cycle colour), the meta row holding a resume percentage (painted the
/// `PROGRESS_PERCENT` role instead of its cycle colour), and the policy-built
/// artwork.
#[derive(Clone, Debug, Eq, PartialEq)]
