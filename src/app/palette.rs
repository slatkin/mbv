...
pub const BLUE: Color = Color::Rgb(56, 75, 85); // dark slate (#384B55)
...
pub const CONTINUE_BG: Color = BLUE; // continue watching list background
pub const MEDIA_SELECTED_BG: Color = BLUE; // selected movie block background in the power view
