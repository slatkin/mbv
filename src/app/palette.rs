...
pub const HOME_PILL_ROW_BG: Color = Color::Rgb(30, 35, 38); // Home pill row background (#1e2326)
pub const HOME_PILL_BG: Color = Color::Rgb(30, 35, 38); // Home pill background (#1e2326)
pub const HOME_PILL_FG: Color = PLAYBACK_META_FG; // unselected Home pill foreground
