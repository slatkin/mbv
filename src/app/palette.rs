...
pub const PILL_SELECTOR_FG: Color = PLAYBACK_META_FG; // unselected pill-selector foreground
pub const PILL_SELECTOR_SELECTED_BG: Color = BG_GREEN; // selected pill-selector surface
