...
// Transitional: the surface table's rows replaced these value-aliased names
// at every production site, but the characterization tests still pin them by
// name (`artwork_placeholder_tests.rs`, `render/tests.rs`), so they stay
// reachable until the retirement unit (task 4.2) removes them.
#[allow(unused_imports)]
pub(crate) use crate::app::render::{
    list_selected_row_bg, resolve_surface_focus, PILL_ROW_BG, PILL_SELECTED_BG,
...
pub(crate) use crate::app::render::{
    ...
    INDICATOR_RESOLUTION_FG, PILL_BG, PILL_FG, PILL_OVERFLOW_FG, PILL_SELECTED_FG,
    PLAYBACK_META_FG, PLAYBACK_THROBBER_FG, PLAYBACK_VALUE_FG, PROGRESS_TRACK, SCROLLBAR,
    STATUS_AVAILABLE, STATUS_ERROR, SURFACE_CHROME, SURFACE_FOCUSED, SURFACE_ITEM_FOCUSED,
    SURFACE_RESTING, SURFACE_SIDEBAR, TEXT_ACCENT_MUTED, TEXT_DETAIL_META, TEXT_EMPHASIS,
