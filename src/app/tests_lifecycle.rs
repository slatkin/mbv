...
fn legacy_launch_migration_uses_stable_item_and_ignores_cursor_index() {
    ...
    assert_ne!(state.item, Some(mbv_core::config::LibraryItemIdentity::Emby { id: "99".into() }));
...
#[test]
fn malformed_legacy_preferences_fall_back_to_home_once() {
    let mut app = crate::app::render::make_movie_app();
    app.tab = TabSelection::Home;
    app.legacy_launch_tab = None;
