...
pub(crate) use theme::{
    ...
    PROGRESS_TRACK, SCROLLBAR, STATUS_AVAILABLE, STATUS_ERROR, SURFACE_BACKDROP, SURFACE_CHROME,
    SURFACE_FOCUSED, SURFACE_ITEM_FOCUSED, SURFACE_PLAYBACK, SURFACE_RESTING, SURFACE_SIDEBAR,
    TEXT_ACCENT_MUTED, TEXT_DETAIL_META, TEXT_EMPHASIS, TEXT_FOCUS_ACCENT, TEXT_METADATA,
    TEXT_MUTED, TEXT_ON_ACCENT, TEXT_PRIMARY, TEXT_SECONDARY, TEXT_STRONG, TEXT_TAB_INACTIVE,
};
...
// still name them.
#[cfg(test)]
pub(crate) use theme::{list_selected_row_bg, SURFACE_ACCENT_SOFT, SURFACE_ARTWORK_PLACEHOLDER};
