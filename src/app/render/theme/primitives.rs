...
/// A played media-list row's title. Holds the muted soft-white the ordinary
/// emphasis role used before the swap; a played row reads as watched and
/// dimmer than the ordinary cream title.
pub(super) const PLAYED_ROW: Color = Color::Rgb(190, 197, 178); // played media-list row title (#bec5b2)
pub(super) const SOFT_WHITE: Color = Color::Rgb(250, 237, 205); // warm soft-white emphasis text (#faedcd)
