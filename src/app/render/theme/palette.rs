...
impl Palette {
    ...
    pub(in crate::app) const fn color(self) -> Color {
        match self {
            ...
            Palette::Green1 => Color::Rgb(0x22, 0x2b, 0x26),
            Palette::Green2 => Color::Rgb(0x2e, 0x3b, 0x34),
...
mod tests {
    ...
    fn palette_rgb_table_tracks_the_green_shift() {
        assert_eq!(Palette::Green1.color(), Color::Rgb(0x22, 0x2b, 0x26));
        assert_eq!(Palette::Green2.color(), Color::Rgb(0x2e, 0x3b, 0x34));
    }
