...
pub(in crate::app::render) const SERIES_DETAIL_DIVIDER_ROWS: usize = 1; // season summary/pills row
pub(in crate::app::render) const SERIES_DETAIL_EPISODE_ROWS_ESTIMATE: usize = 8; // estimated visible episode rows
...
impl App {
    pub(in crate::app::render) fn series_selection_state(
        &self,
        lib_idx: usize,
        series_id: &str,
    ) -> (bool, Option<usize>) {
