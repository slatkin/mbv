...
// Test seam for resolve_device_endpoint's live-session lookup (#239),
// mirroring DAEMON_ROUTE_CONNECT_OVERRIDE/_TEST_LOCK above: lets tests
// inject a fake session list without a real network call.
#[cfg(test)]
type SessionsLoadFn =
