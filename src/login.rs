        ...
        match key.code {
            ...
            KeyCode::Enter => {
                ...
                let config = Config {
                    ...
                    spectrum_snapserver_host: base_config.spectrum_snapserver_host.clone(),
                    spectrum_snapserver_port: base_config.spectrum_snapserver_port,
                    spectrum_snapclient_host_id: base_config.spectrum_snapclient_host_id.clone(),
                    spectrum_snapclient_instance: base_config.spectrum_snapclient_instance,
                    spectrum_fifo_path: base_config.spectrum_fifo_path.clone(),
